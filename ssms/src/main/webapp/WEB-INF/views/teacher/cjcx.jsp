        ...
        function saveGrade() {
			...
			$("#fm").form("submit",{
			   url:"scoreModifyServlet?sno="+sno+"\&cno="+cno+"\&year="+year+"\&semester="+
			   		encodeURI(encodeURI(semester))+"\&chapter="+chapter+"\&grade="+grade,
				onSubmit:function () {
...
<div id="toolbar">
	<div>
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="addTabs('添加成绩','addScorePage.jsp')">添加成绩</a>
...
<div id="dlg" class="easyui-dialog" style="width: 400px;height: 280px;padding: 10px 20px" closed="true" buttons="#dlg-buttons">
	<form id="fm" method="post">
		<table>
			...
			<tr>
				<td>成绩</td>
				<td><input type="text" name="grade" id="fm_grade" data-options="required:true" class="easyui-validatebox"></td>
			</tr>
		</table>
	</form>
</div>
